...
export const projectsData: Project[] = [
  {
    type: "client",
    description:
      "Next.js, TypeScript, Prisma, MariaDB, Strapi CMS, Cloudflare, Caching Architecture, Performance Optimization",
  ...
  },
  {
    ...
    title: "Portage Creek Web Designs - Portfolio Websites - Client Project (Upwork)",
    src: portage,
    year: "2025",
    explore: "Explore",
    ctaText: "Live",
